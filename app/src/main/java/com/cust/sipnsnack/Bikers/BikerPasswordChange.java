...
public class BikerPasswordChange extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_biker_password_change);

        loadingDialog = new LoadingDialog(BikerPasswordChange.this);
        ...
        mDatabase.getInstance().getReference().child("Users").child("Bikers")
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(BikerPasswordChange.this, "Password Updated Successfully ... ", Toast.LENGTH_SHORT).show();

                        Intent intent = new Intent(getApplicationContext(), BikersView.class);
