...
public class FoodFeedbackDetails extends AppCompatActivity {

    LoadingDialog loadingDialog;
    TextView customerNameTV, customerPhoneNoTV, feedbackTV;
    Button backBTN;
    String name, phone, feedback, dbKey;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_feedback_details);

        loadingDialog = new LoadingDialog(FoodFeedbackDetails.this);
    ...
    public void setTextViews() {
        name = FoodFeedbackAdapter.name;
        phone = FoodFeedbackAdapter.phone;
        feedback = FoodFeedbackAdapter.feedback;
        dbKey = FoodFeedbackAdapter.id;
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (loopSize == 0) {
                            ...
                            Toast.makeText(FoodFeedbackDetails.this, "No Item Founded ...", Toast.LENGTH_SHORT).show();
