...
public class PrintInvoice extends AppCompatActivity {
    ...
    String username, name, phone, address, payment, qty, price, receipt, acceptedBy, orderId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new LoadingDialog(PrintInvoice.this);
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (loopSize == 0) {
                            ...
                            Toast.makeText(PrintInvoice.this, "No Item Founded ...", Toast.LENGTH_SHORT).show();
    ...
    public void printReceipt() {
        LayoutInflater layoutInflater1 = LayoutInflater.from(PrintInvoice.this);
        ...
        final AlertDialog alertDialog = new AlertDialog.Builder(PrintInvoice.this)
                .setView(view).create();
        alertDialog.show();
                ...
                Thread t = new Thread() {
                    ...
                    public void run() {
                        try {
                            ...
                            BILL = BILL
                                    + "--------------------------------\n";
                            BILL = BILL + String.format("%1$-6s %2$8s %3$10s", "Size", "Quantity", "Price");
                            BILL = BILL + "\n";
                            BILL = BILL
                                    + "--------------------------------";
                            ...
                            for (int i = 0; i < MyAcceptedOrderData.itemId.length; i++) {
                                ...
                                BILL = BILL + "\n " + String.format("%1$-6s", MyAcceptedOrderData.
                                        itemName[i]);

                                BILL = BILL + "\n " + String.format("%1$-10s %2$5s %3$6s",
                                        MyAcceptedOrderData.itemSize[i],
                                        MyAcceptedOrderData.itemQuantity[i],
                                        MyAcceptedOrderData.itemTotalPrice[i]);
        ...
        switch (mRequestCode) {
            ...
            case REQUEST_ENABLE_BT:
                if (mResultCode == Activity.RESULT_OK) {
                    ...
                    Toast.makeText(PrintInvoice.this, "Message", Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            Toast.makeText(PrintInvoice.this, "DeviceConnected", Toast.LENGTH_SHORT).show();
        }
    };
