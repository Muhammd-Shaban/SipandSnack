...
public class YearWiseReports extends AppCompatActivity {

    Toolbar toolbar;
    int loopSize;
    SearchView searchView;
    YearsReportAdapter myAdapter;
    private RecyclerView.LayoutManager layoutManager;
    private static RecyclerView recyclerView;
    ArrayList<ReportsModel2> yearWises;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_year_wise_reports);

        toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Search Year");

        loadingDialog = new LoadingDialog(YearWiseReports.this);

        recyclerView = (RecyclerView) findViewById(R.id.yearlyReports_recycler_view);
        ...
        yearWises = new ArrayList<ReportsModel2>();
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            ...
                            MonthWiseData.month[j] = snapshot.child("Year").getValue().toString();
                        ...
                        for (int i = 0; i < MonthWiseData.month.length; i++) {
                            yearWises.add(new ReportsModel2(
                        ...
                        if (loopSize == 0) {
                            loadingDialog.dismissDialog();
                            Toast.makeText(YearWiseReports.this, "No Data Founded ...", Toast.LENGTH_SHORT).show();
                            ...
                            myAdapter = new YearsReportAdapter(yearWises);
