...
public class PopularItems4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_popular_items4);

        loadingDialog = new LoadingDialog(PopularItems4.this);
        loadingDialog.startLoadingDialog();

        img1 = findViewById(R.id.img4);

        bt1 = findViewById(R.id.changeImg4);

        bt2 = findViewById(R.id.btn1);
        bt3 = findViewById(R.id.btn2);
        bt4 = findViewById(R.id.btn3);
        ...
        bt3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(getApplicationContext(), PopularItems2.class);
                startActivity(it);
                finish();
            }
        });
            ...
            uploadTask = (UploadTask) fileReference.putFile(imageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            databaseReference.child("Image4").child("ImageUrl").setValue(downloadUrl.toString());

                            loadingDialog.dismissDialog();
                            Toast.makeText(PopularItems4.this, "Uploaded Successfully...", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(PopularItems4.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
