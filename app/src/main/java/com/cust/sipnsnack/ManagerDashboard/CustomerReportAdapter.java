...
public class CustomerReportAdapter extends RecyclerView.Adapter <CustomerReportAdapter.MyViewHolder> implements Filterable {

    private ArrayList<ReportModel> dataSet;
    List<ReportModel> listFull;

    public CustomerReportAdapter(ArrayList<ReportModel> data) {
        this.dataSet = data;
    ...
    public CustomerReportAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        CustomerReportAdapter.MyViewHolder myViewHolder = new CustomerReportAdapter.MyViewHolder(view);
        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(CustomerReportAdapter.MyViewHolder holder, final int listPosition) {
                ...
                yesBTN.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        FirebaseDatabase.getInstance().getReference().child("ReportsForSystem").
                                child("Customers").child(dataSet.get(listPosition).getId()).removeValue();
                        try {
                            Thread.sleep(600);
