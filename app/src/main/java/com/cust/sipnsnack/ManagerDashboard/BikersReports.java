...
public class BikersReports extends Fragment {
    ...
    TextView tv;
    BikerReportAdapter myAdapter;
    int loopSize;

    public BikersReports() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parentHolder = inflater.inflate(R.layout.bikers_reports, container,
                false);
    ...
    void ReadFromDB() {
        ...
        FirebaseDatabase.getInstance().getReference().child("ReportsForSystem").child("Bikers")
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            ...
                            SystemReportsData.name[j] = snapshot.child("BikerName").getValue().toString();
                            SystemReportsData.phone[j] = snapshot.child("BikerPhoneNo").getValue().toString();
                        ...
                        if (loopSize == 0) {
                            ...
                            myAdapter = new BikerReportAdapter(myReport);
