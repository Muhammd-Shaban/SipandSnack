...
public class PopularItems3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_popular_items3);

        loadingDialog = new LoadingDialog(PopularItems3.this);
        loadingDialog.startLoadingDialog();

        img1 = findViewById(R.id.img3);

        bt1 = findViewById(R.id.changeImg3);
            ...
            uploadTask = (UploadTask) fileReference.putFile(imageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            databaseReference.child("Image3").child("ImageUrl").setValue(downloadUrl.toString());

                            loadingDialog.dismissDialog();
                            Toast.makeText(PopularItems3.this, "Uploaded Successfully...", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(PopularItems3.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
