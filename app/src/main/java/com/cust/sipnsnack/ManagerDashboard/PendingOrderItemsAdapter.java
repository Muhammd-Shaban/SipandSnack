...
public class PendingOrderItemsAdapter extends RecyclerView.Adapter <PendingOrderItemsAdapter.MyViewHolder> {

    public ArrayList<PendingOrderItems> dataSet;
    ...
    public PendingOrderItemsAdapter(ArrayList<PendingOrderItems> data) {
        this.dataSet = data;
    }
    ...
    @Override
    public PendingOrderItemsAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.bill_item_design, parent, false);
        PendingOrderItemsAdapter.MyViewHolder myViewHolder = new PendingOrderItemsAdapter.MyViewHolder(view);
        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(PendingOrderItemsAdapter.MyViewHolder holder, final int listPosition) {
