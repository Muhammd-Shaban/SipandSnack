...
public class Pending_fragment extends Fragment {
    ...
    TextView tv;
    CustomerPendingAdapter ordersAdapter;
    int loopSize;
    String dbUsername;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parentHolder = inflater.inflate(R.layout.pending_fragment, container,
                false);
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            ...
                            if (snapshot.exists()) {
                                ...
                                if (dbUsername.equals(OrdersHistory.customerUsername)) {
                                    ...
                                    CustomerOrdersData.orderQty[j] = snapshot.child("TotalQty").getValue().toString();
                        ...
                        if (loopSize == 0) {
                            ...
                            SharedPreferences spr = getActivity().getSharedPreferences("LoginSPR", Context.MODE_PRIVATE);

                            ordersAdapter = new CustomerPendingAdapter(myOrder, spr.getString("Username", ""));
