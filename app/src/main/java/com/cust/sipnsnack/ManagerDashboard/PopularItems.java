...
public class PopularItems extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new LoadingDialog(PopularItems.this);
        loadingDialog.startLoadingDialog();

        img1 = findViewById(R.id.img1);

        bt1 = findViewById(R.id.changeImg1);
            ...
            uploadTask = (UploadTask) fileReference.putFile(imageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            databaseReference.child("Image1").child("ImageUrl").setValue(downloadUrl.toString());

                            loadingDialog.dismissDialog();
                            Toast.makeText(PopularItems.this, "Banner Uploaded Successfully...", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(PopularItems.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
